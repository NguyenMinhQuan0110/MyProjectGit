...
<body>
	...
	<div class="container mt-3">
		<!-- Tạo một layout chia 2 cột -->
	    <div class="row">
	        <!-- Cột danh sách người dùng bên trái -->
	        <div class="col-md-3">
	            <h4>Mọi người</h4>
	            <div class="list-group">
	                <!-- Lặp qua danh sách người dùng và hiển thị -->
	                <c:forEach items="${users}" var="user">
	                    <a href="${rootpath}posts/profile/${user.userID}" class="list-group-item list-group-item-action">
	                        ${user.username}
	                    </a>
	                </c:forEach>
	            </div>
		 ...
		 <!-- Cột bài viết bên phải (không thay đổi) -->
        <div class="col-md-9">
		<c:forEach items="${posts}" var="item">

			<div style="width: 67%; margin: 0 auto; margin-left: 0">
				<hr>
